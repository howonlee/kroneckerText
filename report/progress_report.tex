...
This is a simplistic argument, but can be made less simplistic in talking about arbitrary information in bits instead of symbols in a normal alphabet. However, this theory is only compatible with a random typewriter of information with independence of the typing. However, the example of Shannon's communication game, where one guesses the next word based upon the previous word in a communication, implies that some conditional structure exists in language, since humans can play this communication game. %%%% cite for Shannon's communication game
. 
...
\begin{figure}
  %%%%%%%%%%% make all these figures and then add them
  \includegraphics[width=0.3\textwidth]{bigram_sparsematplot.png}
  \includegraphics[width=0.3\textwidth]{kronfit_sparsematplot.png}
  \includegraphics[width=0.3\textwidth]{kronfit6_sparsematplot.png}
  %%%% below are statistical analyses of generated text
  \includegraphics[width=0.3\textwidth]{kronfit6_outdegree.png}
  \includegraphics[width=0.3\textwidth]{kronfit6_densification.png}
  \includegraphics[width=0.3\textwidth]{kronfit6_eigenvector.png}
  \caption{} %%%%%%%%%%%%%%%%%%%%%% fill this up
\end{figure}
%%%%% one figure, one big caption, no titles, no legends, axis labels
%%%%% examples of some generated text

%%%%% add some desultory discussion, know that it's shit right now, we need to do trigrams, but it's a great compression basically
