...
%%% citations to add: snap, networkx, honnibal, metzenmacher, some respected conll paper with averaged perceptron, the Brown corpus, Stack overflow corpus. add them in the text, too
