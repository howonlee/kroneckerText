...
\subsection{Methods}
We used the Brown NLTK corpus for the model, along with the tags that come with it on NLTK. There are 1161192 words in the corpus, from a vocabulary of 56057 words.
...
% we did a bigram baseline instead of trigram because that's easier.
% talk about the logic of the tries at the POS tag that we did
