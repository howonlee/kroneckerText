...
%%% fold this literature review into a really short one.
...
%%% the probability of the node being connected to every other node is ...

Nodes corresponding to words of the same length have a degree distribution distributed normally. %%% continue... with mixture distribution below
...
Which has a well-defined mean and variance. If we assume that we have a word of a certain length $N$, and uniform probabilities of the words, then we can get to the central limit theorem because of this. %%%% un-bullshit this

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% take the mathematical analysis that they have over there, and run with it

%%% compare with stack overflow net
%%% also compare with kronecker graph

%%% x: degree y: count
%%% x: rank y: singular value
%%% x: degree y: clustering coefficient %%%maybe something different?
%%% x: degree y: triads %%% maybe something different?

\subsection{Results and Discussion of the POS Task}

%four purposes to this project
...
%%% where's the mathematical analysis?
%%% and a LOT of error analysis
