...
%%% what about the POS tags? vocab size of the tags and of the bigrams of tags
...
%%% note the number of parameters in the kronecker graph, be pessimistic about it because actually you need the node labellings

%%% convince the reader that Kronecker graphs have faults for this: talk about the weights, cop out about how it wasn't within the scope of the project really. talk about the node matching problem. give an example of a mismatched node, maybe one with a fucked-up degree there
