...
Nodes corresponding to words of the same length have a degree distribution distributed normally. To have an edge in the graph is to be next to each other in the corpus. %%% finish proof!
