...
\subsection{Language Network Properties}

%%% compare with flickr network or something like that
%%% also compare with kronecker graph

%%% x: degree y: count
%%% x: rank y: singular value
%%% x: degree y: clustering coefficient
%%% x: number of hops y: number of node pairs

\subsection{Results and Discussion}

%four purposes to this project
%%% convince the reader that language model graph is a small world graph
