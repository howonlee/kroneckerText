...
%%%%%%% consider the POS tagging problem. Split it into two: there's generation and matching. We are looking at generation.
...
The problem that this language model should be used in is a part-of-speech tagger. The language model can be fit into a POS tagger as a prior for the optimization target in a noisy channel model.%%%% citation for what POS taggers are
