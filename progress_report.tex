...
%%%%%% add a lot of small simple graphs for the power laws indegree, outdegree, eigenvectors, densification, etc
...
%%%%% add the sparse matrix plot of the bigram
%%%%% add the sparse matrix plot that we made of kronfit graph
%%%%% add some generated text
%%%%% add some statistical analysis of generated text

%%%%% one figure, one big caption, no titles, no legends, axis labels
%%%%% add some desultory discussion
