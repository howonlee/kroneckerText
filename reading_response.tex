...
There is ample room for criticizing the decision to say that two words are linked to each other if they are within two words of each other in a corpus. %%%%%%%%% fractal brocolli example, not at all scales
